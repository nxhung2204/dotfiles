...
3. **AUTONOMOUS MODE:** Nếu được gọi từ implement-issue skill → commit trực tiếp, KHÔNG hỏi
4. **INTERACTIVE MODE:** Nếu gọi trực tiếp → hiển thị message và hỏi "Ready to commit? (y/n)"
...
- Check context: Nếu parent skill là implement-issue → skip confirmation, commit immediately
- Nếu gọi standalone → show confirmation prompt
